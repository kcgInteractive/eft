<?php
if ( ! function_exists( 'fluid_edge_init_google_fonts_array' ) ) {
    function fluid_edge_init_google_fonts_array() {

        global $fluid_edge_global_fonts_array;
        $fluid_edge_global_fonts_array =
        array (
            0 =>
                array (
    ...
    add_action('after_setup_theme', 'fluid_edge_init_google_fonts_array');
}