...
if(!function_exists('edgtf_core_include_custom_post_types_meta_boxes')) {
	...
	add_action('fluid_edge_action_before_meta_boxes_map', 'edgtf_core_include_custom_post_types_meta_boxes');
}
...
if(!function_exists('edgtf_core_include_custom_post_types_global_options')) {
	...
	add_action('fluid_edge_action_before_options_map', 'edgtf_core_include_custom_post_types_global_options', 1);
}