...
class TeamMember implements Lib\ShortcodeInterface {
    ...
    public function vcMap() {
        if(function_exists('vc_map')) {
	        vc_map( array(
			        'name'                      => esc_html__( 'Edge Team Member', 'edgtf-core' ),
			        'base'                      => $this->getBase(),
			        ...
			        'params'                    => array(
                        array(
                            ...
                            'heading'     => esc_html__('Team Layout', 'edgtf-core'),
                            'value'       => array(
                        ...
                        array(
					        ...
					        'heading'    => esc_html__( 'Select Team Member', 'edgtf-core' ),
					        'settings'   => array(
						        'sortable'      => true,
						        'unique_values' => true
					        ),
    ...
    public function render($atts, $content = null) {
        ...
        $html = edgtf_core_get_cpt_shortcode_module_template_part('team', 'team-template-'.$params['team_member_layout'], '', $params);
