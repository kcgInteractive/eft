...
if(!function_exists('edgtf_core_add_pricing_table_shortcodes')) {
	function edgtf_core_add_pricing_table_shortcodes($shortcodes_class_name) {
		$shortcodes = array(
	...
	add_filter('edgtf_core_filter_add_vc_shortcode', 'edgtf_core_add_pricing_table_shortcodes');
}
