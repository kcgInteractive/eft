		...
		if ( $twitter_api->hasUserConnected() ) {
			...
			if ( $response->status ) {
				if ( is_array( $response->data ) && count( $response->data ) ) { ?>
					<ul class="edgtf-twitter-widget <?php echo esc_attr( $holder_classes ); ?>" <?php echo fluid_edge_get_inline_attrs( $slider_data ); ?>>
						<?php foreach ( $response->data as $tweet ) { ?>
							
							<?php if ( $type_of_widget == 'slider' ) { ?>
								
								<li class="edgtf-tweet-holder">
									<div class="edgtf-tweet-text" <?php fluid_edge_inline_style( $twitter_style ); ?>>
