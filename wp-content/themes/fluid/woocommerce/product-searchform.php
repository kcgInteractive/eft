...
<form role="search" method="get" class="woocommerce-product-search searchform" action="<?php echo esc_url(home_url('/')); ?>">
    ...
    <div class="input-holder clearfix">
        <input type="search" class="search-field" placeholder="<?php echo esc_html__('Search Products...', 'fluid'); ?>" value="<?php echo get_search_query(); ?>" name="s" title="<?php echo esc_html__('Search for:', 'fluid'); ?>"/>
